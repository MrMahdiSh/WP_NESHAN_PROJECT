    ...
    class MPTBM_Dependencies
    {
        ...
        public function global_enqueue()
        {
            ...
            if ($api_key) {
                ...
                wp_enqueue_script('neshanbazi', 'https://static.neshan.org/sdk/openlayers/v8.1.0/neshan-sdk/v1.0.5/index.js', array(), null, true);
                wp_enqueue_style('neshanCS', 'https://static.neshan.org/sdk/openlayers/v8.1.0/neshan-sdk/v1.0.5/index.css', array(), time());
